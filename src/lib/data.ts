...
export const skills: Skill[] = [
  ...
  // ─── IA GENERATIVA ──────────────────────────────────────────
  { name: "ChatGPT", icon: "/chatgpt-logo.png", percent: 90, category: "ai", level: "Avançado", description: "Geração de código, revisão, pair programming, arquitetura de soluções", experience: "2+ anos", tier: "expert" },
